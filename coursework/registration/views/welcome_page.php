        ...
        <section class="welcome-section">
            <div class="welcome-container">
                ...
                <div class="cta-buttons">
                   ...
                   <a href="../views/about_matrix.php" class="cta-button">О нас</a>
                </div>
            </div>
        </section>
        ...
        <div class="recommendations">
            ...
            <div class="recommendation-cards">
                <div class="recommendation-card">
                    <h4>HealthTech Стартап</h4>
                    <p>"Инновационное решение для телемедицины с потенциалом роста 200%. Подходит под ваши интересы в сфере здравоохранения."</p>
                    <button class="btn-explore">Узнать больше</button>
                </div>
                <div class="recommendation-card">
                    <h4>Fintech Платформа</h4>
                    <p>"Новый сервис для управления финансами с уже привлеченными $2M. Соответствует вашей инвестиционной стратегии."</p>
                    <button class="btn-explore">Узнать больше</button>
                </div>
                <div class="recommendation-card">
                    <h4>GreenTech Проект</h4>
                    <p>"Экологически чистые технологии с прогнозируемым ROI 15%. Учитывая ваши прошлые инвестиции, это может быть интересно."</p>
                    <button class="btn-explore">Узнать больше</button>
                </div>
            </div>
        </div>
...
<section class="calculator-section">
    <div class="container">
        ...
        <p class="subheading">Введите сумму инвестиций и срок, чтобы узнать потенциальную доходность.</p>
        <div class="calculator">
            <input type="number" id="investmentAmount" placeholder="Сумма инвестиций" />
            <input type="number" id="investmentPeriod" placeholder="Срок (в месяцах)" />
        ...
        <!-- Секция виртуального инвестирования -->
<section class="virtual-investing">
    <div class="container">
        <h2>Тренировка инвестирования</h2>
        <p class="subheading">Практикуйте инвестиционные стратегии с виртуальным капиталом в реальных рыночных условиях</p>
        
        <!-- Панель управления инвестициями -->
        <div class="investing-controls">
            <div class="control-group">
                <label for="virtualCapital">Виртуальный капитал:</label>
                <select id="virtualCapital">
                    <option value="10000">$10,000</option>
                    <option value="50000">$50,000</option>
                    <option value="100000">$100,000</option>
                    <option value="custom">Свой вариант</option>
                </select>
                <input type="number" id="customCapital" placeholder="Введите сумму" style="display:none;">
            </div>
            
            <div class="control-group">
                <label for="marketSector">Рыночный сектор:</label>
                <select id="marketSector">
            ...
            <div class="control-group">
                <label for="timePeriod">Период времени:</label>
                <select id="timePeriod">
                    <option value="realtime">Реальное время</option>
                    <option value="historical">Исторические данные</option>
                </select>
            </div>
            
            <button id="startSimulation" class="cta-button">Начать симуляцию</button>
        </div>
        
        <!-- Основная панель симуляции -->
        <div class="simulation-dashboard" style="display:none;">
            <div class="dashboard-header">
                <div class="portfolio-summary">
                    <h3>Ваш виртуальный портфель</h3>
                    <div class="portfolio-stats">
                        <div class="stat">
                            <span class="label">Общая стоимость:</span>
                            <span class="value" id="portfolioValue">$10,000.00</span>
                        </div>
                        <div class="stat">
                            <span class="label">Доходность:</span>
                            <span class="value positive" id="portfolioReturn">+0.00%</span>
                        </div>
                        <div class="stat">
                            <span class="label">Доступно:</span>
                            <span class="value" id="availableCash">$10,000.00</span>
                        </div>
                    </div>
                </div>
                
                <div class="market-indices">
                    <h3>Рыночные индексы</h3>
                    <div class="indices-list">
                        <div class="index">
                            <span class="name">S&P 500</span>
                            <span class="value">4,567.89</span>
                            <span class="change positive">+0.45%</span>
                        </div>
                        <div class="index">
                            <span class="name">NASDAQ</span>
                            <span class="value">14,210.34</span>
                            <span class="change positive">+0.78%</span>
                        </div>
                        <div class="index">
                            <span class="name">Dow Jones</span>
                            <span class="value">34,567.12</span>
            ...
            <div class="asset-list">
                ...
                <div class="asset-filters">
                    <input type="text" placeholder="Поиск активов..." id="assetSearch">
                    <select id="assetSort">
                ...
                <div class="assets-grid">
                    ...
                    <div class="asset-card">
                        ...
                        <div class="asset-price">
                            <span class="current">$175.34</span>
                            <span class="change positive">+1.23%</span>
                        </div>
                        <div class="asset-chart mini-chart">
                            <canvas id="aaplMiniChart"></canvas>
                        </div>
                        <div class="asset-actions">
                            <input type="number" placeholder="Кол-во" min="1" class="quantity-input">
                            <button class="buy-btn">Купить</button>
                            <button class="sell-btn" disabled>Продать</button>
                        </div>
                    </div>
                    ...
                    <div class="asset-card">
                        ...
                        <div class="asset-price">
                            <span class="current">$265.78</span>
                            <span class="change negative">-0.45%</span>
                        </div>
                        <div class="asset-chart mini-chart">
                            <canvas id="tslaMiniChart"></canvas>
                        </div>
                        <div class="asset-actions">
                            <input type="number" placeholder="Кол-во" min="1" class="quantity-input">
                            <button class="buy-btn">Купить</button>
                    ...
                    <div class="asset-card">
                        ...
                        <div class="asset-price">
                            <span class="current">$135.67</span>
                            <span class="change positive">+0.89%</span>
                        </div>
                        <div class="asset-chart mini-chart">
                            <canvas id="googlMiniChart"></canvas>
                        </div>
                        <div class="asset-actions">
                            <input type="number" placeholder="Кол-во" min="1" class="quantity-input">
                            <button class="buy-btn">Купить</button>
                    ...
                    <div class="asset-card">
                        <div class="asset-header">
                            ...
                            <span class="name">Amazon.com Inc.</span>
                        </div>
                        <div class="asset-price">
                            <span class="current">$145.23</span>
                            <span class="change positive">+0.34%</span>
                        </div>
                        <div class="asset-chart mini-chart">
                            <canvas id="amznMiniChart"></canvas>
                        </div>
                        <div class="asset-actions">
                            <input type="number" placeholder="Кол-во" min="1" class="quantity-input">
                            <button class="buy-btn">Купить</button>
            ...
            <div class="transaction-history">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td colspan="7" class="empty-message">У вас пока нет операций</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="simulation-actions">
                <button id="resetSimulation" class="secondary-button">Начать заново</button>
                <button id="saveSimulation" class="secondary-button">Сохранить симуляцию</button>
                <button id="endSimulation" class="cta-button">Завершить симуляцию</button>
            </div>
        </div>
        
        <!-- Аналитика симуляции -->
        <div class="simulation-analytics" style="display:none;">
            <h3>Результаты вашей симуляции</h3>
            <div class="analytics-grid">
                <div class="analytics-card">
                    <h4>Общая доходность</h4>
                    <div class="value" id="finalReturn">+0.00%</div>
                    <div class="comparison">
                        <span>По сравнению с S&P 500: </span>
                        <span class="outperformance positive">+0.00%</span>
                    </div>
                </div>
                ...
                <div class="analytics-card">
                    <h4>Рекомендации</h4>
                    <div class="recommendations">
                        <p>На основе вашей стратегии мы рекомендуем:</p>
                        <ul>
                            <li>Диверсифицировать портфель</li>
                            <li>Рассмотреть сектор технологий</li>
                            <li>Увеличить горизонт инвестирования</li>
                        </ul>
                    </div>
                </div>
            </div>
            
            <button id="newSimulation" class="cta-button">Начать новую симуляцию</button>
        </div>
    </div>
</section>
        ...
        <section class="premium-unlock-section">
            <div class="container">
                <div class="premium-content">
                    ...
                    <a class="cta-button" href="https://your-payment-link.com">Перейти на премиум</a>
                    <p class="small-text">Начните 14-дневный бесплатный пробный период. Без кредитной карты.</p>
                    <p>Отсканируйте QR-код ниже для оплаты:</p>
                    <div class="qr-code-container">
                    <img src="../images/frame.png" alt="QR Code для оплаты">
                    </div>
                    <p>Или перейдите по <a href="https://your-payment-link.com">ссылке</a>.</p>
                </section>
        ...
        <script>
            new QRCode(document.getElementById("qrcode"), "https://your-payment-link.com");
        </script>
        <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
        <script src="../js/investment-simulation.js"></script>
        <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
        <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/three.js/r128/three.min.js"></script>
